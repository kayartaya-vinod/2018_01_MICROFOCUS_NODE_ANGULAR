...
let factorial = __webpack_require__(6);
...
// module
exports.push([module.i, "/* src/style1.css */\n\n#heading1 {\n    color: #8a138a;\n}", ""]);
...
var person_1 = __webpack_require__(8);
var p1 = new person_1.Person('Vinod', 45);
p1.addPhone('9731424784');
p1.addPhone('9844083934');
console.log("Person data: " + p1); // p1.toString() is called while concatenating
console.log('Author info: ', person_1.AUTHOR_INFO);
console.log(p1.getPhones());
var mu = __webpack_require__(9);
...
exports.__esModule = true;
exports.AUTHOR_INFO = { name: 'Vinod', email: 'vinod@vinod.co' };
